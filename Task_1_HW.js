...
for (item = 0; item < users.length; item++){
    ...
    if (users[item].registrationDate.includes('10.10.2021'))
    console.log('Родился 10.10.2021 -', users[item].firstName)
    else if (users[item].registrationDate.includes('09.10.2021'))
    console.log('Родился 09.10.2021 -', users[item].firstName)
}
}
happyBirthday()
